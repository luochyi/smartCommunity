...
<script>
import Preview from '@/views/charge/components/dailyMayment/Preview'
import {
...
export default {
                ...
                thead: [
                    ...
                    { label: '待缴金额', prop: 'paymentPrice', width: '180' },
                    {
                        ...
                        callback: (row, prop) => {
                            ...
                            //         break;
                            // }
                            let timeDate = Math.round(
                                (new Date().getTime() -
                                    new Date(row.paymentTerm).getTime()) /
                                    1000 /
                                    60 /
                                    60 /
                                    24
    ...
    methods: {
       ...
       * */
            let resData = {
                buildingUnitEstateId:
                    this.addForm.ruleForm.buildingUnitEstateId,
                chargesTemplateDetailId:
                    this.addForm.ruleForm.chargesTemplateDetailId,
