      ...
      <div class="content">
        <div class="content-btn">
          <el-button class="init-button"
                     @click="add()"
                     icon="el-icon-plus">新增商家</el-button>
    ...
    return {
      ...
      config: {
        thead: [
          ...
          { label: '服务商家', prop: 'facilitiesCategoryName', width: 'auto' },
          { label: '所属分类', prop: 'item', width: 'auto' },
          { label: '机构类型', prop: 'mechanismItem', width: 'auto' },
          { label: '商家服务数量', prop: 'number', width: 'auto' },
