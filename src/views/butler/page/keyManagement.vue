      ...
      <div class="content">
        <div class="content-btn">
          <el-button class="init-button"
                     @click="add()"
                     icon="el-icon-plus">新增钥匙记录</el-button>
    ...
    return {
      ...
      config: {
        thead: [
          ...
          { label: '设备名称', prop: 'facilitiesCategoryName', width: 'auto' },
          { label: '钥匙数量', prop: 'addressee', width: 'auto' },
          { label: '对应位置', prop: 'tel', width: 'auto' },
          { label: '管理人', prop: 'address', width: 'auto' },
          { label: '发布时间', prop: 'expressCompany', width: 'auto' },
        ],
        table_data: [],
