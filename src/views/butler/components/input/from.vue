    ...
    <div class="title-input">
      <el-form :model="form" ref="form" label-width="auto" size="small">
        <div class="title-input-box">
          <div class="title-item" v-for="item in formItem" :key="item.prop">
            <el-form-item
              :prop="item.prop"
              :label="item.label"
            ...
            >
              ...
              <el-date-picker
                v-else-if="item.type === 'startEndDate'"
                v-model="form[item.prop]"
                type="daterange"
        ...
        <div class="title-input-btn" style="width:10%">
          <el-form-item label-width="0px">
            <button class="inquire-button" @click="onSubmit('form')">
              查询
            </button>
            <button class="reset-button" @click="resetForm('form')">
              重置
            </button>
          </el-form-item>
        </div>
