                    ...
                    >
                        ...
                        <template slot="footer">
                            <div class="table-footer">
                                <button @click="lease(table_row)">启用</button>
                            ...
                            <template>
                                ...
                                >
                                    ...
                                    <template slot="imgUrls">
                                        <template>
                                            <el-upload
                                                :action="`${$baseUrl}upload/uploadGeographyImg`"
...
export default {
        ...
        return {
            ...
            config: {
                thead: [
                    ...
                    { label: '地理介绍', prop: 'content', width: 'auto' },
                    {
                        label: '启用状态',
                        prop: 'status',
                        width: 'auto',
    ...
    methods: {
        ...
        addRuleSuccess() {
            ...
            // console.log('resData')
            // console.log(resData)
            geographyInsert(resData).then((res) => {
                if (res.status) {
                    this.$message({
                        message: res.message,
                        type: 'success'
        ...
        detail(data) {
            if (data.length != 1) {
                ...
                this.imglist = []
                geographyFindById({ geographyId: data[0].id }).then((res) => {
        ...
        detailRuleSuccess() {
            ...
            geographyUpdate(resData).then((res) => {
                if (res.status) {
                    this.$message({
                        message: res.message,
                        type: 'success'
        ...
        lease(data) {
            if (data.length != 1) {
                ...
                geographyEnable({ geographyId: data[0].id }).then((res) => {
                    if (res.status) {
                        this.$message({
                            message: res.message,
                            type: 'success'
